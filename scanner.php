                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="card_profile_content">
                                        <div class="form_group form_name">
                                            ...
                                            <label class="form_lbl">Name</label>
                                            <input type='text' class='form_txt_sm' name='newName'>
                                    ...
                                    <button type="submit" name="submit" class="form_app_submit submit_profile btn_orange">Save</button>
                                </form>
                    ...
                    <div class="activity_container">
                        ...
                        <div class="activity_calendar_listing_container">
                            ...
                            <div class="calendar_rows_container">
                                ...
                                <?php
                                    $sql = "SELECT date_created FROM checkin";
                                    ...
                                    while($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<div class='calendar_row'><div class='calendar_company'>KevinHaha Sdn Bhd</div>                            <div class='calendar_branch'>Kuala Lumpur</div>";
                                        echo "<div class='calendar_date'>".$date."</div>";
                                        echo "<div class='calendar_time'>".$time."</div></div>";
                                    }
                                    }                                                     
